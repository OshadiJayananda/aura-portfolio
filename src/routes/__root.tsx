...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Software Engineering undergraduate and Full Stack Developer crafting performant, modern web experiences." },
      { name: "author", content: "Portfolio" },
      { property: "og:title", content: "Portfolio — Software Engineer & Full Stack Developer" },
      { property: "og:description", content: "Software Engineering undergraduate and Full Stack Developer crafting performant, modern web experiences." },
